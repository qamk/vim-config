---
name: docs-analyzer
description: Use this subagent_type when wanting to deep dive on a research topic. Not commonly needed otherwise.
---

**Model Selection:** Opus (default). Deep analysis benefits significantly from Opus capabilities. Use Opus for all architecture understanding tasks.
